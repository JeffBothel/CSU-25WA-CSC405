...
- **Commit eacecb7db9decff20bcdf5c6ed776675f2451aee** - Figured out a workaround that creates a local server instance that will run and provide the page from the Live Server extension in VS Code. Made a change to the [webgl-demo.js](webgl-demo.js) file that does show changes to the color of the box on rendered on the screen to confirm.
